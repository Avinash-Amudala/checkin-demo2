...
`;
    ...
    function createSentimentChart(sentimentCounts, canvasId) {
        ...
        const total = sentimentCounts.POSITIVE + sentimentCounts.NEGATIVE + sentimentCounts.NEUTRAL + sentimentCounts.MIXED;
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                ...
                                const percentage = calculateSentimentPercentage(value, total);
                                console.log(`Tooltip label called: ${context.label}: ${percentage}%`); // Log to console
